...
import { Dashboard2Preview } from '@app/entityV2/dashboard2/preview/Dashboard2Preview';
import { Dashboard2StatsSummarySubHeader } from '@app/entityV2/dashboard2/profile/Dashboard2StatsSummarySubHeader';
import Dashboard2SummaryTab from '@app/entityV2/dashboard2/summary/Dashboard2SummaryTab';
...
export class Dashboard2Entity implements Entity<Dashboard2> {
    ...
    renderProfile = (urn: string) => (
        <EntityProfile
            ...
            tabs={[
                {
                    name: 'Summary',
                    component: Dashboard2SummaryTab,
    ...
    getOverridePropertiesFromEntity = (dashboard?: Dashboard2 | null): GenericEntityProperties => {
    ...
    renderPreview = (previewType: PreviewType, data: Dashboard2) => {
