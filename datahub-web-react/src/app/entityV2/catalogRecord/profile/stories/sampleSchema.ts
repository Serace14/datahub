...
export const sampleSchema: SchemaMetadata | Schema | null = {
    ...
    platformSchema: {
        ...
        schema: '{ "type": "record", "name": "SampleHdfsSchema", "namespace": "com.linkedin.catalogRecord", "doc": "Sample HDFS CatalogRecord", "fields": [ { "name": "field_foo", "type": [ "string" ] }, { "name": "field_bar", "type": [ "boolean" ] } ] }',
    },
};
                ...
                tags: [
                    {
                        tag: {
                            ...
                            name: 'Legacy',
                            description: 'this is a legacy CatalogRecord',
                            type: EntityType.Tag,
                        },
            ...
            sourceFields: [
                {
                    ...
                    parent: { urn: 'test', type: EntityType.CatalogRecord },
                    fieldPath: 'shipping_address',
                },
            ],
            foreignFields: [
                {
                    urn: dataset3.urn,
                    type: EntityType.CatalogRecord,
                    parent: { urn: dataset3.name, type: EntityType.CatalogRecord },
                    fieldPath: 'address',
                },
            ],
