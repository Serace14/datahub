...
import StatsSection from '@app/entityV2/catalogRecord/profile/stats/StatsSection';
import ProfilingRunsChart from '@app/entityV2/catalogRecord/profile/stats/historical/charts/ProfilingRunsChart';
import StatChart from '@app/entityV2/catalogRecord/profile/stats/historical/charts/StatChart';
import {
...
export default function HistoricalStatsView({ urn, toggleView }: Props) {
    ...
    const profiles = profilesData?.catalogRecord?.datasetProfiles || [];
