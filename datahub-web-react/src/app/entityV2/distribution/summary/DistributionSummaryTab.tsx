...
import DistributionSummaryOverview from '@app/entityV2/distribution/summary/DistributionSummaryOverview';
...
export default function DistributionSummaryTab(): JSX.Element | null {
    const { entityData } = useEntityData();

    return (
        <SummaryTabWrapper>
            <DistributionSummaryOverview />
            <StyledDivider />
            <SummaryAboutSection />
