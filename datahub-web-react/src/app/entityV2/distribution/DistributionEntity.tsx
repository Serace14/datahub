...
import { DistributionPreview } from '@app/entityV2/distribution/preview/DistributionPreview';
import { DistributionStatsSummarySubHeader } from '@app/entityV2/distribution/profile/DistributionStatsSummarySubHeader';
import DistributionSummaryTab from '@app/entityV2/distribution/summary/DistributionSummaryTab';
...
import { Distribution, EntityType, LineageDirection, SearchResult } from '@types';

const PREVIEW_SUPPORTED_PLATFORMS = [LOOKER_URN, MODE_URN];

/**
 * Definition of the DataHub Distribution entity.
 */
...
export class DistributionEntity implements Entity<Distribution> {
    ...
    renderProfile = (urn: string) => (
        <EntityProfile
            ...
            tabs={[
                {
                    name: 'Summary',
                    component: DistributionSummaryTab,
                ...
                },
                {
                    ...
                    icon: EyeOutlined,
                    display: {
                        visible: (_, distribution: GetDistributionQuery) =>
                            !!distribution?.distribution?.urn,
                        enabled: (_, distribution: GetDistributionQuery) =>
                            !!distribution?.distribution?.urn,
                    },
                },
                {
    ...
    renderPreview = (previewType: PreviewType, data: Distribution) => {
