...
import ExpandingStat from '@app/entity/catalogRecord/shared/ExpandingStat';
import { FormattedBytesStat } from '@app/entity/catalogRecord/shared/FormattedBytesStat';
...
export const CatalogRecordStatsSummary = ({
    rowCount,
    columnCount,
    sizeInBytes,
    totalSqlQueries,
