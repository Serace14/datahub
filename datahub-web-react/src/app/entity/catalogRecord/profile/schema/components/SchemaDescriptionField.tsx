...
import { UpdateCatalogRecordMutation } from '@graphql/catalogRecord.generated';
...
type Props = {
    ...
    onUpdate: (
        description: string,
    ) => Promise<FetchResult<UpdateCatalogRecordMutation, Record<string, any>, Record<string, any>> | void>;
    isEdited?: boolean;
    isReadOnly?: boolean;
