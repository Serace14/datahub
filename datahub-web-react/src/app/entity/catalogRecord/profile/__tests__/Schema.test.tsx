...
} from '@app/entity/catalogRecord/profile/stories/sampleSchema';
import { EntityContext } from '@app/entity/shared/EntityContext';
import { SchemaTab } from '@app/entity/shared/tabs/catalogRecord/Schema/SchemaTab';
import { SchemaRow } from '@app/entity/shared/tabs/catalogRecord/Schema/components/SchemaRow';
...
describe('Schema', () => {
    ...
    it('renders foreign keys', () => {
        ...
        expect(getAllByText('Yet Another catalogRecord')).toHaveLength(2);
    });
