...
@Slf4j
public class CatalogRecordUsageStatsResolver
    implements DataFetcher<CompletableFuture<UsageQueryResult>> {

  private final UsageClient usageClient;

  public CatalogRecordUsageStatsResolver(final UsageClient usageClient) {
