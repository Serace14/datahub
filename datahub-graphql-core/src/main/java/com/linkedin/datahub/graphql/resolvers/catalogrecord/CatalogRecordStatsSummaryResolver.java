...
/**
 * This resolver is a thin wrapper around the {@link CatalogRecordUsageStatsResolver} which simply
 * computes some aggregate usage metrics for a Dashboard.
 */
@Slf4j
public class CatalogRecordStatsSummaryResolver
  ...
  public CatalogRecordStatsSummaryResolver(final UsageStatsJavaClient usageClient) {
