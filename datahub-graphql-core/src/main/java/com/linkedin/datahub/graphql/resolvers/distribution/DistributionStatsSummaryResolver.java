package com.linkedin.datahub.graphql.resolvers.distribution;
...
import com.linkedin.datahub.graphql.generated.DistributionStatsSummary;
...
@Slf4j
public class DistributionStatsSummaryResolver
    implements DataFetcher<CompletableFuture<DistributionStatsSummary>> {
  ...
  public DistributionStatsSummaryResolver(final UsageStatsJavaClient usageClient) {
    this.usageClient = usageClient;
  }

  @Override
  public CompletableFuture<DistributionStatsSummary> get(DataFetchingEnvironment environment)
      throws Exception {
