package com.linkedin.metadata.aspect.patch.template.dashboard2;
...
import com.linkedin.dashboard2.Dashboard2Info;
import com.linkedin.data.template.RecordTemplate;
import com.linkedin.metadata.aspect.patch.template.ArrayMergingTemplate;
import java.util.Collections;
import javax.annotation.Nonnull;

public class Dashboard2InfoTemplate implements ArrayMergingTemplate<Dashboard2Info> {
  ...
  private static final String DASHBOARDS_FIELD_NAME = "dashboards2";

  @Override
  public Dashboard2Info getSubtype(RecordTemplate recordTemplate) throws ClassCastException {
    if (recordTemplate instanceof Dashboard2Info) {
      return (Dashboard2Info) recordTemplate;
    }
    throw new ClassCastException("Unable to cast RecordTemplate to DataJobInputOutput");
  }

  @Override
  public Class<Dashboard2Info> getTemplateType() {
    return Dashboard2Info.class;
  }

  @Nonnull
  @Override
  public Dashboard2Info getDefault() {
    Dashboard2Info dashboardInfo = new Dashboard2Info();
